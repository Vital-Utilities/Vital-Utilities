...
pub struct GetMachineDynamicDataResponse {
    ...
    pub cpu_usage_data: Option<Box<crate::models::CpuUsages>>,
    #[serde(rename = "ramUsagesData", skip_serializing_if = "Option::is_none")]
    pub ram_usages_data: Option<Box<crate::models::RamUsages>>,
    ...
    pub network_usage_data: Option<Box<crate::models::NetworkAdapters>>,
