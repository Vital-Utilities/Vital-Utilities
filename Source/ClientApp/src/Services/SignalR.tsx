...
import {
	recieveDeleteManagedProcessAction,
	recieveManagedProcessAddedAction,
	recieveManagedProcessUpdatedAction,
} from "../Redux/actions/managedModelActions";
...
const ManagedHubSignalR: React.FunctionComponent = () => {
	...
	React.useEffect(() => {
		...
		const connection = new HubConnectionBuilder()
			.withUrl(`http://localhost:${appState.vitalServicePort}/ManagedHub`)
		...
		connection.on(
			"MachineDynamicData",
			(data: GetMachineDynamicDataResponse) => {
